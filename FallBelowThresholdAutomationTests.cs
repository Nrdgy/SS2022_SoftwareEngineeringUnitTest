...
{
    [TestClass()]
    public class FallBelowThresholdAutomationTests
    {
        [TestMethod()]
        public void FallBelowThresholdAutomation_EmptyActionList()
        {
            List<IAction> actions = new List<IAction>();
            FallBelowThresholdAutomation automation = new FallBelowThresholdAutomation(1.0, actions);
            Assert.AreEqual(actions, automation.actions);

        }

        [TestMethod()]
        public void FallBelowThresholdAutomation_FilledActionList()
        {
            List<IAction> actions = new List<IAction>
            {
                new NotifyAction()
        ...
        public void CheckValue_IsBelowThreshold()
        {
            ...
            List<IAction> actions = new List<IAction>();
            FallBelowThresholdAutomation automation = new FallBelowThresholdAutomation(threshold, actions);
